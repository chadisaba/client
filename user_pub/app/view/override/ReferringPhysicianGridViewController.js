...
/*
    var params;
            ...
            var cityNaComboStore=this.getViewModel().getStore('CityNaComboStore');
            var cityNaComboStoreData=[];
            Server.CommonQueries.read(params,
            function(res){
            if(res.success){
            cityNaComboStoreData=res.data;
            cityNaComboStore.loadData(cityNaComboStoreData);
                }
                else{
