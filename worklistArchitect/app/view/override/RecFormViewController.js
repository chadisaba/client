Ext.define('MyApp.view.override.RecFormViewController', {
    override: 'MyApp.view.RecFormViewController',

    onRecFormItemIdBoxReady: function(component, width, height, eOpts) {
    ...
    initForm: function(_formId) {
        ...
        var rec;
            ...
            var regcFormuleComboStore=this.getViewModel().getStore('RegcFormuleComboStore');
            CommonDirect.getData("xxTableName",filtersArray)
            .then(function (_resultArray) {
             me.getViewModel().getStore('RegcFormuleComboStore').loadData(_resultArray);
             });
        filtersArray=[{
            name:"",
            value:""
            ...
            var amcIdComboStore=this.getViewModel().getStore('AmcIdComboStore');
            CommonDirect.getData("xxTableName",filtersArray)
            .then(function (_resultArray) {
             me.getViewModel().getStore('AmcIdComboStore').loadData(_resultArray);
             });
