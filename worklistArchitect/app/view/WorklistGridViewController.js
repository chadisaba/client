...
Ext.define('MyApp.view.WorklistGridViewController', {
    ...
    duPatientRenderer: function(value, metaData, record, rowIndex, colIndex, store, view) {

    },

    duRegoRenderer: function(value, metaData, record, rowIndex, colIndex, store, view) {

    },

    duRegcRenderer: function(value, metaData, record, rowIndex, colIndex, store, view) {

    },

    duFtPatientRenderer: function(value, metaData, record, rowIndex, colIndex, store, view) {

    },

    duFtRego: function(value, metaData, record, rowIndex, colIndex, store, view) {
