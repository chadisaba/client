...
Ext.define('MyApp.view.WorklistGrid', {
    ...
    columns: [
        ...
        {
            xtype: 'gridcolumn',
            renderer: 'duPatientRenderer',
            dataIndex: 'visitBalancePatient',
            text: 'P. due'
        },
        {
            xtype: 'gridcolumn',
            renderer: 'duRegoRenderer',
            dataIndex: 'visitBalanceRego',
            text: 'AMO due'
        },
        {
            xtype: 'gridcolumn',
            renderer: 'duRegcRenderer',
            dataIndex: 'visitBalanceRegc',
            text: 'AMC due'
        },
        {
            xtype: 'gridcolumn',
            renderer: 'duFtPatientRenderer',
            dataIndex: 'visitBalancePatientFt',
            hidden: true,
            text: 'Dû F.T'
        },
        {
