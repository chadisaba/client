/*
 * File: app/view/EstHasServFormViewController.js
 *
...
Ext.define('MyApp.view.EstHasServFormViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.esthasservform',

    requires: [
        'MyApp.view.override.EstHasServFormViewController'
    ],

    onEstHasServFormItemIdBoxReady: function(form) {
